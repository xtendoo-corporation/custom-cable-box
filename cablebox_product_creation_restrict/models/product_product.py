    ...
    def create(self, vals_list):
        ...
        if authorized_user_params:
            ...
            if self.env.uid not in authorized_user_ids:
                # Verificamos si se está creando desde un template ya existente (variante)
                # o si es un producto nuevo completamente.
                # En Odoo, crear un product.template crea automáticamente un product.product.
                # El chequeo en product.template debería ser suficiente para la mayoría de los casos de interfaz.
